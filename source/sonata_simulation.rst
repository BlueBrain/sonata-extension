...
.. table::
   ...
   neuromod_dtc                   float      Optional     Only applicable to NeuroModulation projections. It overrides the "neuromod_dtc" values between the selected source and target neurons, representing the decay time constant of the neuromodulator concentration at the target synapse.
   neuromod_strength              float      Optional     Only applicable to NeuroModulation projections. It overrides the "neuromod_strength" values between the selected source and target neurons, representing the amount of increase of the neuromodulator concentration at the synapse when an incoming neuromodulatory event (i.e., a spike in the virtual pre-synaptic neuron) is transmitted to the target synapse.
   ============================== ========== ============ ==========================================
