...
.. table::
   ...
   integration_method              text       Optional    Selects the NEURON/CoreNEURON `integration method <https://nrn.readthedocs.io/en/latest/python/simctrl/programmatic.html#secondorder>`_. This parameter sets the NEURON global variable h.secondorder. The allowed values are "euler" (default) for fully implicit backward euler, "crank_nicolson" for Crank-Nicolson and "crank_nicolson_ion" for Crank-Nicolson with fixed ion currents.
