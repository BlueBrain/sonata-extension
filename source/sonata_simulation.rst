...
.. table::
   ...
   connection_type                text       Optional     Type of the connectivity between the source and target of injection. Supported values are :ref:`the connection types of populations<edge_pop_type>`: "chemical", "electrical", "synapse_astrocyte", "endfoot", "neuromodulatory". Default is "chemical".
   ============================== ========== ============ ==========================================
