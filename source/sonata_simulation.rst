...
.. table::
   ...
   neuromodulation_dtc            float      Optional     Only applicable to NeuroModulation projections. It overrides the ``neuromod_dtc`` values between the selected source and target neurons, representing the decay time constant of the neuromodulator concentration at the target synapse.
